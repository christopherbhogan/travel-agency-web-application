...
This project contains the back-end components of a web application built using Spring Boot. It was built using a lab virtual lab environment provided by WGU. An existing MySQL database as well as an Angular front-end were supplied in the lab environment.
